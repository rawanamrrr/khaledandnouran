  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      <Button
        ...
        size="icon"
        onClick={toggleMute}
        className="rounded-full w-12 h-12 bg-accent/80 hover:bg-accent text-accent-foreground shadow-lg transition-all duration-300 flex items-center justify-center backdrop-blur-sm border border-white/20"
