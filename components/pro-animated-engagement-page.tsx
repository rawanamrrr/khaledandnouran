...
interface ProAnimatedWeddingPageProps {
  onImageLoad?: () => void;
  playGifTrigger?: boolean;
}

export default function ProAnimatedWeddingPage({ onImageLoad, playGifTrigger }: ProAnimatedWeddingPageProps) {
  ...
  const pathY2 = useTransform(scrollYProgress, [0, 0.5], [0, 40])
    ...
    const eventDate = new Date("2025-12-17T19:00:00");
