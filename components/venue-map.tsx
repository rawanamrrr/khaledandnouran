...
export default function VenueMap() {
  ...
  const googleMapsUrl = "https://maps.app.goo.gl/G5Q4LMqcfmr4enYb9"
        ...
        <div className="relative group">
          ...
          <div className="mt-6 text-center px-4">
            <h3 className="text-xl sm:text-2xl font-serif font-medium text-foreground mb-2">
                            {isRTL ? ' قاعة الماسة' : 'AL MASSA HALL '}
            </h3>
              ...
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                ...
                                <span>{isRTL ? 'الحديقة الدولية، مدينة نصر' : 'The International Park, Nasr City'}</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
